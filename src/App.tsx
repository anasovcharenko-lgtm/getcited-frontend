...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw{to{stroke-dashoffset:0}} .l1{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s ease forwards} .l2{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.25s ease forwards} .l3{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.5s ease forwards} .l4{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.75s ease forwards} .l5{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 1s ease forwards} .l6{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 1.25s ease forwards}"}</style><path className="l1" d="M-50 480 C 100 460 150 500 250 440 C 350 380 370 420 470 380 C 570 340 600 390 720 330 C 840 270 880 320 1000 260 C 1100 210 1150 240 1250 200" fill="none" stroke="#E5E5E5" strokeWidth="1" strokeLinecap="round"/><path className="l2" d="M-50 450 C 80 430 140 470 260 410 C 380 350 400 400 510 355 C 620 310 660 360 780 300 C 900 240 940 290 1060 230 C 1140 190 1180 210 1250 180" fill="none" stroke="#D4D4D4" strokeWidth="1.2" strokeLinecap="round"/><path className="l3" d="M-50 420 C 70 390 130 440 240 380 C 350 320 390 370 500 320 C 610 270 660 330 790 265 C 920 200 960 255 1080 195 C 1155 160 1190 175 1250 155" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" opacity="0.7"/><path className="l4" d="M-50 390 C 60 350 120 410 230 345 C 340 280 380 340 500 285 C 620 230 670 295 800 225 C 930 155 970 215 1090 155 C 1160 120 1195 138 1250 120" fill="none" stroke="#737373" strokeWidth="1" strokeLinecap="round" opacity="0.5"/><path className="l5" d="M-50 350 C 90 300 160 370 280 295 C 400 220 430 290 560 230 C 690 170 740 240 870 170 C 1000 100 1040 160 1140 110 C 1190 85 1215 98 1250 88" fill="none" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" opacity="0.7"/><path className="l6" d="M-50 310 C 80 250 160 330 290 250 C 420 170 460 245 600 178 C 740 111 790 185 920 115 C 1050 45 1090 115 1170 72 C 1205 52 1220 62 1250 55" fill="none" stroke="#16A34A" strokeWidth="2.5" strokeLinecap="round"/></svg>
        <Reveal>
