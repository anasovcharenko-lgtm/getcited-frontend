...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw{to{stroke-dashoffset:0}} .l1{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s ease forwards} .l2{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.2s ease forwards} .l3{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.4s ease forwards} .l4{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.6s ease forwards} .l5{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.8s ease forwards} .l6{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 1s ease forwards}"}</style><path className="l1" d="M100 445 L140 430 L165 448 L200 418 L240 438 L275 408 L295 425 L340 388 L370 410 L415 368 L445 390 L490 345 L520 368 L560 322 L605 348 L648 298 L672 325 L718 275 L755 305 L802 252 L835 282 L878 228 L915 262 L958 208 L998 238 L1042 185 L1080 215 L1110 188" fill="none" stroke="#D4D4D4" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.5"/><path className="l2" d="M100 435 L138 455 L172 432 L210 452 L252 422 L282 445 L315 412 L358 435 L395 398 L432 422 L468 385 L508 410 L545 372 L588 398 L628 358 L662 382 L702 340 L742 368 L782 325 L822 352 L862 308 L902 335 L942 290 L982 318 L1022 272 L1062 300 L1102 255 L1122 272" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.4"/><path className="l3" d="M100 460 L145 440 L178 458 L222 435 L258 455 L292 428 L325 448 L368 415 L402 438 L445 402 L478 425 L522 388 L555 412 L598 372 L638 398 L675 355 L708 380 L748 335 L788 362 L828 318 L868 345 L908 300 L948 328 L988 282 L1028 308 L1068 262 L1108 288 L1128 265" fill="none" stroke="#E5E5E5" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" opacity="0.35"/><path className="l4" d="M100 452 L142 468 L175 445 L218 465 L255 440 L288 460 L322 432 L365 452 L400 418 L438 442 L475 405 L515 428 L552 390 L595 415 L635 375 L668 400 L708 355 L748 382 L788 338 L828 365 L868 320 L908 348 L948 302 L988 330 L1028 285 L1068 312 L1108 268 L1128 285" fill="none" stroke="#737373" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" opacity="0.3"/><path className="l5" d="M100 428 L148 408 L182 430 L228 405 L262 428 L298 398 L332 420 L375 382 L408 405 L452 365 L482 388 L528 348 L558 372 L602 330 L642 355 L678 308 L712 335 L752 288 L792 315 L832 268 L872 295 L912 248 L952 278 L992 230 L1032 258 L1072 210 L1112 238 L1132 218" fill="none" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.55"/><path className="l6" d="M100 415 L152 390 L188 415 L235 388 L268 412 L305 380 L340 405 L382 365 L415 392 L460 350 L490 375 L535 332 L565 358 L608 315 L648 342 L685 295 L718 322 L758 275 L798 302 L838 255 L878 282 L918 235 L958 262 L998 215 L1038 242 L1078 195 L1118 222 L1138 202" fill="none" stroke="#16A34A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.8"/></svg>
        <Reveal>
