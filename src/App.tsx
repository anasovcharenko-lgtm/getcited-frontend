...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw{to{stroke-dashoffset:0}} .l1{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3.5s ease forwards} .l2{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3.5s 0.2s ease forwards} .l3{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3.5s 0.4s ease forwards} .l4{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3.5s 0.6s ease forwards} .l5{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3.5s 0.8s ease forwards} .l6{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3.5s 1s ease forwards}"}</style><path className="l1" d="M0 490 C 60 480 80 500 140 470 C 200 440 220 460 280 420 C 340 380 360 410 430 360 C 500 310 510 350 580 290 C 650 230 660 270 740 200 C 820 130 830 180 910 140 C 980 105 1010 130 1080 90 C 1130 62 1160 75 1200 50" fill="none" stroke="#D4D4D4" strokeWidth="1" strokeLinecap="round" opacity="0.4"/><path className="l2" d="M0 495 C 50 485 90 500 160 465 C 230 430 250 455 320 405 C 390 355 410 390 490 330 C 570 270 580 315 660 255 C 740 195 755 240 840 175 C 925 110 940 158 1020 115 C 1085 80 1110 98 1200 65" fill="none" stroke="#E5E5E5" strokeWidth="1.2" strokeLinecap="round" opacity="0.35"/><path className="l3" d="M0 488 C 70 470 100 492 170 450 C 240 408 265 440 340 390 C 415 340 430 375 510 315 C 590 255 605 300 690 235 C 775 170 790 220 875 160 C 950 108 980 145 1055 100 C 1110 68 1145 85 1200 58" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" opacity="0.3"/><path className="l4" d="M0 492 C 55 478 95 498 165 458 C 235 418 255 448 330 395 C 405 342 425 378 505 318 C 585 258 600 305 685 240 C 770 175 785 225 870 162 C 948 106 978 148 1050 103 C 1108 68 1142 86 1200 60" fill="none" stroke="#737373" strokeWidth="0.8" strokeLinecap="round" opacity="0.25"/><path className="l5" d="M0 485 C 65 462 105 488 175 440 C 245 392 268 432 350 372 C 432 312 448 358 535 292 C 622 226 638 278 725 210 C 812 142 828 198 915 148 C 988 106 1018 138 1085 92 C 1135 58 1162 74 1200 48" fill="none" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" opacity="0.5"/><path className="l6" d="M0 480 C 75 448 118 478 195 422 C 272 366 295 415 385 345 C 475 275 492 330 585 258 C 678 186 695 245 790 178 C 885 111 905 168 995 118 C 1065 78 1095 102 1165 62 C 1188 48 1198 52 1200 45" fill="none" stroke="#16A34A" strokeWidth="2.5" strokeLinecap="round" opacity="0.8"/></svg>
        <Reveal>
