...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw1{to{stroke-dashoffset:0}} .l1{stroke-dasharray:2000;stroke-dashoffset:2000;animation:draw1 3s ease forwards} .l2{stroke-dasharray:2000;stroke-dashoffset:2000;animation:draw1 3s 0.4s ease forwards} .l3{stroke-dasharray:2000;stroke-dashoffset:2000;animation:draw1 3s 0.8s ease forwards}"}</style><path className="l1" d="M-50 380 C 50 340, 100 420, 200 370 C 300 320, 350 280, 450 310 C 550 340, 600 260, 700 290 C 800 320, 850 240, 950 260 C 1050 280, 1100 220, 1250 200" fill="none" stroke="#D4D4D4" strokeWidth="1.5" strokeLinecap="round"/><path className="l2" d="M-50 420 C 80 390, 130 440, 230 405 C 330 370, 380 330, 480 355 C 580 380, 630 300, 730 320 C 830 340, 880 265, 980 280 C 1080 295, 1130 240, 1250 225" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" opacity="0.6"/><path className="l3" d="M-50 460 C 60 420, 120 470, 240 435 C 360 400, 410 355, 520 385 C 630 415, 680 330, 790 350 C 900 370, 960 285, 1070 305 C 1150 320, 1190 270, 1250 255" fill="none" stroke="#16A34A" strokeWidth="2.5" strokeLinecap="round"/></svg>
        <Reveal>
