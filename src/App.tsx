...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw{to{stroke-dashoffset:0}} .l1{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s ease forwards} .l2{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.2s ease forwards} .l3{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.4s ease forwards} .l4{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.6s ease forwards} .l5{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 0.8s ease forwards} .l6{stroke-dasharray:2500;stroke-dashoffset:2500;animation:draw 3s 1s ease forwards}"}</style><path className="l1" d="M0 450 C 80 430 120 460 180 390 C 240 320 260 380 340 310 C 420 240 440 300 530 220 C 620 140 640 210 740 160 C 840 110 880 150 980 90 C 1060 45 1120 70 1200 40" fill="none" stroke="#E5E5E5" strokeWidth="1.5" strokeLinecap="round"/><path className="l2" d="M0 480 C 60 450 100 490 170 410 C 240 330 280 410 370 340 C 460 270 480 350 580 260 C 680 170 700 250 800 180 C 900 110 940 170 1040 100 C 1110 55 1150 80 1200 55" fill="none" stroke="#D4D4D4" strokeWidth="1" strokeLinecap="round"/><path className="l3" d="M0 460 C 90 420 130 470 210 380 C 290 290 310 370 410 290 C 510 210 530 290 640 200 C 750 110 770 190 880 130 C 970 80 1020 120 1120 70 C 1160 50 1185 60 1200 45" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" opacity="0.8"/><path className="l4" d="M0 490 C 70 460 110 500 190 420 C 270 340 300 420 400 330 C 500 240 520 320 630 240 C 740 160 760 240 870 165 C 960 100 1010 150 1100 85 C 1150 55 1175 68 1200 50" fill="none" stroke="#737373" strokeWidth="1" strokeLinecap="round" opacity="0.5"/><path className="l5" d="M0 440 C 100 390 140 450 230 350 C 320 250 340 340 450 255 C 560 170 580 260 700 175 C 820 90 850 170 960 100 C 1040 50 1090 85 1160 45 C 1185 30 1198 35 1200 30" fill="none" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" opacity="0.7"/><path className="l6" d="M0 420 C 110 360 160 430 260 320 C 360 210 380 310 500 220 C 620 130 650 220 780 140 C 910 60 940 140 1060 75 C 1130 35 1165 52 1200 25" fill="none" stroke="#16A34A" strokeWidth="2.5" strokeLinecap="round"/></svg>
        <Reveal>
