...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw{to{stroke-dashoffset:0}} .l1{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s ease forwards} .l2{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.2s ease forwards} .l3{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.4s ease forwards} .l4{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.6s ease forwards} .l5{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.8s ease forwards} .l6{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 1s ease forwards}"}</style><path className="l1" d="M100 440 L150 435 L180 445 L220 420 L250 430 L290 405 L320 415 L360 385 L390 400 L430 370 L460 385 L500 350 L530 365 L570 330 L610 348 L650 308 L680 325 L720 285 L760 305 L800 262 L840 282 L880 238 L920 258 L960 212 L1000 235 L1040 188 L1080 208 L1100 190" fill="none" stroke="#D4D4D4" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.5"/><path className="l2" d="M100 450 L140 438 L175 452 L215 425 L248 442 L285 412 L318 428 L358 392 L392 410 L435 375 L465 392 L508 355 L538 372 L578 335 L618 355 L655 312 L688 332 L728 290 L768 312 L808 268 L848 290 L888 245 L928 265 L968 218 L1008 242 L1048 195 L1088 215 L1108 198" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" opacity="0.35"/><path className="l3" d="M100 432 L145 442 L178 428 L225 415 L255 425 L295 398 L328 410 L365 378 L398 395 L438 362 L468 378 L512 342 L542 358 L582 322 L622 342 L658 298 L692 318 L732 275 L772 298 L812 252 L852 275 L892 228 L932 252 L972 205 L1012 228 L1052 182 L1092 202 L1112 185" fill="none" stroke="#E5E5E5" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" opacity="0.4"/><path className="l4" d="M100 425 L148 438 L182 422 L228 408 L258 420 L300 390 L332 405 L370 372 L402 388 L445 355 L472 372 L518 335 L548 352 L588 315 L628 335 L665 290 L698 312 L738 268 L778 292 L818 245 L858 268 L898 222 L938 245 L978 198 L1018 222 L1058 175 L1098 195 L1118 178" fill="none" stroke="#737373" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" opacity="0.3"/><path className="l5" d="M100 418 L152 432 L188 415 L235 400 L262 415 L305 382 L338 398 L378 365 L410 382 L452 348 L480 365 L525 328 L555 345 L595 308 L635 328 L672 282 L705 305 L745 260 L785 285 L825 238 L865 262 L905 215 L945 238 L985 192 L1025 215 L1065 168 L1105 188 L1125 172" fill="none" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.5"/><path className="l6" d="M100 408 L155 425 L192 408 L240 392 L268 408 L312 375 L345 392 L385 358 L418 375 L462 340 L490 358 L535 320 L565 338 L605 300 L645 320 L682 272 L715 298 L755 252 L795 278 L835 230 L875 255 L915 208 L955 230 L995 185 L1035 208 L1075 162 L1115 182 L1132 165" fill="none" stroke="#16A34A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.75"/></svg>
        <Reveal>
