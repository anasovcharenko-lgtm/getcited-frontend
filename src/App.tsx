...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      {/* Hero */}
      <section className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 md:pt-32"><svg className="absolute inset-0 h-full w-full overflow-visible pointer-events-none" viewBox="0 0 1200 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><style>{"@keyframes draw{to{stroke-dashoffset:0}} .l1{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s ease forwards} .l2{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.15s ease forwards} .l3{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.3s ease forwards} .l4{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.45s ease forwards} .l5{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.6s ease forwards} .l6{stroke-dasharray:3000;stroke-dashoffset:3000;animation:draw 4s 0.75s ease forwards}"}</style><path className="l1" d="M0 480 C 40 475 60 490 100 465 C 140 440 160 458 210 435 C 260 412 270 430 330 400 C 390 370 400 390 460 355 C 520 320 525 345 590 305 C 655 265 660 290 730 245 C 800 200 805 230 875 185 C 945 140 950 168 1020 128 C 1075 98 1095 115 1140 88 C 1165 74 1185 80 1200 70" fill="none" stroke="#D4D4D4" strokeWidth="1" strokeLinecap="round" opacity="0.5"/><path className="l2" d="M0 485 C 50 465 70 488 120 455 C 170 422 175 448 240 415 C 305 382 315 405 375 368 C 435 331 445 358 510 318 C 575 278 585 308 655 262 C 725 216 730 248 805 198 C 880 148 888 182 962 138 C 1018 104 1042 122 1090 94 C 1118 78 1140 88 1200 65" fill="none" stroke="#E5E5E5" strokeWidth="1.2" strokeLinecap="round" opacity="0.45"/><path className="l3" d="M0 478 C 45 460 68 480 115 450 C 162 420 172 445 235 408 C 298 371 308 398 372 358 C 436 318 448 342 515 298 C 582 254 592 282 664 234 C 736 186 742 218 818 168 C 894 118 900 152 975 108 C 1032 74 1056 92 1105 65 C 1132 50 1152 60 1200 45" fill="none" stroke="#A3A3A3" strokeWidth="1" strokeLinecap="round" opacity="0.35"/><path className="l4" d="M0 475 C 55 452 78 476 128 442 C 178 408 190 435 258 394 C 326 353 336 382 402 340 C 468 298 478 328 548 282 C 618 236 628 268 700 218 C 772 168 780 202 855 152 C 930 102 938 138 1012 94 C 1068 60 1090 78 1138 52 C 1162 38 1178 46 1200 35" fill="none" stroke="#737373" strokeWidth="0.8" strokeLinecap="round" opacity="0.3"/><path className="l5" d="M0 470 C 60 440 85 468 140 430 C 195 392 208 422 278 378 C 348 334 360 365 432 320 C 504 275 515 308 590 260 C 665 212 675 248 752 196 C 829 144 838 180 915 132 C 978 94 1002 114 1052 84 C 1082 66 1105 78 1150 52 C 1172 38 1188 45 1200 38" fill="none" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" opacity="0.45"/><path className="l6" d="M0 465 C 65 428 92 458 152 415 C 212 372 225 405 300 358 C 375 311 388 345 465 295 C 542 245 555 280 635 228 C 715 176 725 214 805 158 C 885 102 895 142 975 96 C 1038 58 1062 78 1115 48 C 1142 32 1162 42 1200 28" fill="none" stroke="#16A34A" strokeWidth="2" strokeLinecap="round" opacity="0.7"/></svg>
        <Reveal>
